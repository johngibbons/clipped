...
class UploadsControllerTest < ActionController::TestCase
  ...
  test "should create upload" do
    ...
    #   post :create, upload: { image: @upload.image_file_name, tag_list: @upload.tag_list }
    # end
  ...
  test "should update upload" do
    patch :update, id: @upload, upload: { image: @upload.image_file_name, tag_list: @upload.tag_list }
    assert_response :success
  end
