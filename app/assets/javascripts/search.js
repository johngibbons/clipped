$(document).ready(function () {
  ...
  var Filter = (function() {
    function Filter(element) {
      ...
      this._filterLabel = this._element.find(this.constructor.filterLabelSelector);
    }

    Filter.selector = '.filter';
    Filter.optionsContainerSelector = '> div';
    Filter.hideOptionsClass = 'hide-options';
    Filter.filterLabelSelector = '> label';
    ...
    Filter.prototype._bindEvents = function() {
      ...
      this._summaryElement.add(this._filterLabel).click(function() {
        self._toggleOptions();
      });
    ...
    Filter.prototype._updateSummary = function() {
      ...
      if (checked.length > 0 && checked.length < this._checkboxes().length) {
        ...
        this._clearSelectionButton.show();
      }

      this._summaryElement.html(summary);
    };
